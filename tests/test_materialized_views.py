...
def test_materialized_db_view_based_on_raw_sql_without_dependencies(
    ...
    current_date_time_from_view_call_1 = (
        SimpleMaterializedViewWithoutDependencies.objects.get().current_date_time
    )
    current_date_time_from_view_call_2 = (
        SimpleMaterializedViewWithoutDependencies.objects.get().current_date_time
    )
    ...
    current_date_time_from_view_call_3 = (
        SimpleMaterializedViewWithoutDependencies.objects.get().current_date_time
    )
